...
export class MyMigration1704459611668 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "fullName" character varying NOT NULL, "address" character varying, "username" character varying, "gender" character varying, "password" character varying NOT NULL,"role" user_role_enum, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "paslon" ("id" SERIAL NOT NULL, "no" integer NOT NULL, "name" character varying NOT NULL, "visionAndMission" character varying NOT NULL, "picture" character varying, "coalition" character varying NOT NULL, CONSTRAINT "PK_f3367efce21ffeeff1e3f58244d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "partai" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "chairman" character varying NOT NULL, "visionAndMission" character varying NOT NULL, "address" character varying NOT NULL, "picture" character varying, "paslonId" integer, "nomor_urut" integer,  CONSTRAINT "PK_9c5c70fa29884e15f3b88a1b40b" PRIMARY KEY ("id"))`);
